  	...
  	<div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          	...
          	<div class="x_content">
				...
				<?php echo form_open('im_concepto/add',array("class"=>"form-horizontal")); ?>
					...
					<div class="form-group">
							...
							<div class="col-md-8">
								<select name="idImg" class="form-control">
									...
									{
										$selected = ($im_general['id'] == $this->input->post('idImg')) ? ' selected="selected"' : "";
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="idConcepto" value="<?php echo $this->input->post('idConcepto'); ?>" class="form-control" id="idConcepto" />
						</div>
					</div>
					<div class="form-group">
						<label for="partida" class="col-md-4 control-label">Partida</label>
						<div class="col-md-8">
							<input type="text" name="partida" value="<?php echo $this->input->post('partida'); ?>" class="form-control" id="partida" />
						</div>
					</div>
					<div class="form-group">
						<label for="plazoEntrega" class="col-md-4 control-label">PlazoEntrega</label>
						<div class="col-md-8">
							<input type="text" name="plazoEntrega" value="<?php echo $this->input->post('plazoEntrega'); ?>" class="form-control" id="plazoEntrega" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="lugarEntrega" value="<?php echo $this->input->post('lugarEntrega'); ?>" class="form-control" id="lugarEntrega" />
						</div>
					</div>
					<div class="form-group">
						<label for="direccionEntrega" class="col-md-4 control-label">DireccionEntrega</label>
						<div class="col-md-8">
							<textarea name="direccionEntrega" class="form-control" id="direccionEntrega"><?php echo $this->input->post('direccionEntrega'); ?></textarea>
						</div>
					</div>
