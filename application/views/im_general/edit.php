                    ...
                    if($num_partidas >= 1) {
                        for ($i = 0; $i < $num_partidas; $i++)
                        {
                            ...
                            if (count($output2[$i]) <= 1){
                                ...
                                echo "Intervalo con el número máximo de frecuencias: ".($key+1);
                                echo "<br>";
                                echo "<br>";
