...
class Po_general extends CI_Controller{
    ...
    function editRelacionIMConcepto(){
        ...
        $idImc = $this->Pogeneralmodel->get_idImc($idPog, $idArticulo, $idProveedor, $partida, $plazoEntrega);
    ...
    function editHistorico(){
        ...
        //Obtener el ID de la tabla im_concepto
        //En caso de que sea un registro nuevo, se tiene que obtener el id consecutivo
        $idImc = $this->Pogeneralmodel->get_idImcH($idPog, $idArticulo, $idProveedor, $partida);
